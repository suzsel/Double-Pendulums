...
# Initial conditions
initial_conditions = []
base_angle = 13 * np.pi/12  # Base angle for initial condition
...
ani.save(filename="animations/pendulums1000_2/double_pendulum1000.gif", writer='pillow', dpi=300, fps=125) # dpi = 300
